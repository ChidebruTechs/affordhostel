...
import { ArrowLeft, CreditCard, Smartphone, Shield, Download, CheckCircle, AlertCircle, Clock } from 'lucide-react';
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4 mb-6">
            <div className="flex justify-between">
              <span className="text-gray-600">Hostel:</span>
              <span className="font-semibold">{bookingData.hostelName}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Room Type:</span>
              <span className="font-semibold">{bookingData.roomType}</span>
            </div>
            <div className="flex justify-between">
          ...
          <div className="border-t pt-4 space-y-3">
            <div className="flex justify-between">
              <span className="text-gray-600">Accommodation Fee:</span>
              <span>Ksh {bookingData.amount.toLocaleString()}</span>
            </div>
            <div className="flex justify-between">
