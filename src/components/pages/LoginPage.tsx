...
const LoginPage: React.FC = () => {
  ...
  const getRoleSpecificFields = () => {
    switch (formData.role) {
      case 'student':
        return (
          <div className="space-y-4 mt-2 p-4 bg-purple-50 rounded-lg">
      ...
      case 'landlord':
        return (
          <div className="space-y-4 mt-2 p-4 bg-teal-50 rounded-lg">
      ...
      case 'agent':
        return (
          <div className="space-y-4 mt-2 p-4 bg-orange-50 rounded-lg">
      ...
      case 'admin':
        return (
          <div className="space-y-4 mt-2 p-4 bg-red-50 rounded-lg">
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8 mt-4" >
            ...
            <div className="grid grid-cols-2 gap-2">
              {roles.map((role) => (
                <button
                  ...
                  className={`p-2 text-left border-2 rounded-lg transition-all duration-200 hover:shadow-md ${
